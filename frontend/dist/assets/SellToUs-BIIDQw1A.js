...
import { a as B, _ as T } from './index-DeqD4MY7.js';
import { j as e } from './react-query-BGeIQRPr.js';
import { r as m } from './react-CTDr35rJ.js';
import { u as D, a as q, C as n, o as M, s as c, c as P, b as V, e as _ } from './zod-SQF3v9p3.js';
import { F as o } from './FormField-iyrhpl26.js';
import { I as d, S, d as O, B as k } from './antd-n40S5sxn.js';
const L = m.lazy(() => T(() => import('./ImageUploader-DWnjEkzb.js'), __vite__mapDeps([0, 1, 2]))),
  R = M({
    contact_name: c().min(1, 'Name is required'),
    email: c().email('Invalid email'),
    phone: c().optional(),
    brand: _(['NVIDIA', 'AMD'], { required_error: 'Brand is required' }),
    model: c().min(1, 'Model is required'),
    grade: _(['A', 'B', 'C']).default('B'),
    warranty: V().default(!1),
    accessories: c().optional(),
    expected_price: P.number().min(1, 'Expected price must be ≥ 1'),
    note: c().optional(),
  });
function J() {
  var x, p, u, j, b, g, v, f, y, w;
  const [F, C] = m.useState([]),
    [E, h] = m.useState(!1),
    {
      ...
      handleSubmit: A,
      formState: { errors: s },
    } = D({ resolver: q(R), defaultValues: { grade: 'B', warranty: !1 } });
  async function I(a) {
    var N;
    ...
    children: [
      ...
      e.jsxs('form', {
        ...
        children: [
            ...
            children: [
              ...
              e.jsx('div', {
                ...
                children: e.jsx(o, {
                  label: 'Warranty',
                  htmlFor: 'warranty',
                  error: (v = s.warranty) == null ? void 0 : v.message,
                  children: e.jsx(n, {
                    name: 'warranty',
                    control: r,
                    render: ({ field: a }) =>
              ...
              e.jsx('div', {
                ...
                children: e.jsx(o, {
                  label: 'Accessories',
                  htmlFor: 'accessories',
                  error: (f = s.accessories) == null ? void 0 : f.message,
                  children: e.jsx(n, {
                    name: 'accessories',
                    control: r,
          ...
          e.jsx('div', {
            className: 'mb-3',
            children: e.jsx(m.Suspense, { fallback: null, children: e.jsx(L, { onChange: C }) }),
          }),
          e.jsx(k, { type: 'primary', htmlType: 'submit', loading: E, children: 'Submit' }),
        ],
      }),
    ],
  });
